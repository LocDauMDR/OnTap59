...
public class JFrameTable extends javax.swing.JFrame {
    ...
    public JFrameTable() {
        initComponents();
//        TableAdapter adapter = new TableAdapter(); Nếu không dùng static thì khởi tạo 
        ArrayList<SinhVien> list = new ArrayList<>();
        list.add(new SinhVien("Hoàng", "Hà Tĩnh", "04/12/1999"));
        list.add(new SinhVien("Dương", "Khánh Hòa", "24/08/1999"));
        list.add(new SinhVien("Ngân", "Đắk Lắk", "19/07/1999"));
        tableSV.setModel(TableAdapter.listAdapter(list));
    }
